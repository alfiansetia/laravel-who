        ...
        <div class="card card-sm">
            <div class="card-header d-flex align-items-center flex-wrap" style="gap: 8px;">
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap: 6px; flex: 1;">
                    <div class="input-group input-group-sm" style="max-width: 400px;">
                        ...
                        <input type="search" id="searchInput" class="form-control form-control-sm"
                            placeholder="Cari nomor, SN, product...">
                    </div>
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                    <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ route('kargans.create') }}'">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-modern" id="tableKargan" style="width:100%">
                        <thead>
                            <tr>
                                <th style="width: 30px;">
    ...
    <script>
        ...
        function renderTable(data) {
            ...
            data.forEach(row => {
                ...
                const productDisplay = productCode ? `[${productCode}] ${productName}` : escapeHtml(row.product_id || '');
        ...
        function renderPagination(page, totalPages, total) {
            ...
            $pag.off('click', '.page-btn').on('click', '.page-btn', function() {
                ...
                loadData();
                $('html, body').animate({
                    scrollTop: $('#tableKargan').offset().top - 80
                }, 200);
            });
        }
