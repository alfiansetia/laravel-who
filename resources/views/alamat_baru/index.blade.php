        ...
        <div class="card card-sm">
            <div class="card-header d-flex align-items-center flex-wrap" style="gap: 8px;">
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap: 6px; flex: 1;">
                    <div class="input-group input-group-sm" style="max-width: 400px;">
                        ...
                        <input type="search" id="searchInput" class="form-control form-control-sm"
                            placeholder="Cari DO, tujuan, ekspedisi...">
                    </div>
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                    <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ route('alamat_baru.create') }}'">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-modern" id="tableAlamatBaru" style="width:100%">
                        <thead>
                            <tr>
                                <th style="width: 30px;">
    ...
    <script>
        ...
        function renderTable(data) {
            ...
            data.forEach(row => {
                html += `<tr data-id="${row.id}">
                    ...
                    <td style="width:20%">${escapeHtml(row.do)}</td>
                    <td>${escapeHtml(row.tujuan)}</td>
                    <td>${escapeHtml(row.ekspedisi)}</td>
                    <td class="text-center">${row.total_koli} Koli</td>
                </tr>`;
            });
        ...
        function renderPagination(page, totalPages, total) {
            ...
            $pag.off('click', '.page-btn').on('click', '.page-btn', function() {
                ...
                loadData();
                $('html, body').animate({
                    scrollTop: $('#tableAlamatBaru').offset().top - 80
                }, 200);
            });
        }
