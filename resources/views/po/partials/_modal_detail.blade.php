        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            <div class="modal-header"
                ...
                <h5 class="modal-title font-weight-bold" id="modalTitle">
                    <i class="fas fa-info-circle mr-2"></i>Detail PO
                </h5>
            ...
            <div class="modal-body">
                <table class="table table-hover" id="tableProduct" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30px" class="text-center">QTY RI</th>
                            <th style="width: 30px" class="text-center">QTY SISA</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
                ...
                <div class="mt-2">
                    <b>Notes</b> :
                    <div class="po-notes" id="modalNote"></div>
                </div>
            </div>
