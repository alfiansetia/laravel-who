...
@section('content')
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between p-4 rounded-lg shadow-sm border-0" 
                    ...
                    <div>
                        <h2 class="font-weight-bold mb-1 ml-2"><i class="fas fa-sparkles mr-2 text-warning"></i> OCR Logic Workbench</h2>
                        <p class="mb-0 opacity-75 ml-2 font-weight-light">Ekstraksi teks dari gambar & PDF dengan presisi tinggi.</p>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-7">
                <div class="card card-sm border-0 shadow-lg overflow-hidden h-100 mb-4">
                    <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                        <h6 class="font-weight-bold m-0 text-primary"><i class="fas fa-file-image mr-2"></i>SOURCE DOCUMENT</h6>
                        <div class="d-flex align-items-center" style="gap: 10px;">
                            <div id="pdfControls" style="display: none;" class="btn-group">
                                <button class="btn btn-xs btn-outline-primary" onclick="changePage(-1)"><i class="fas fa-chevron-left"></i></button>
                                <span class="btn btn-xs btn-light disabled px-3">Page <span id="currentPage">1</span>/<span id="totalPages">1</span></span>
                                <button class="btn btn-xs btn-outline-primary" onclick="changePage(1)"><i class="fas fa-chevron-right"></i></button>
                            </div>
                            <button id="resetSourceBtn" class="btn btn-xs btn-outline-danger d-none" onclick="resetSource()" title="Clear Image">
                    ...
                    <div class="card-body p-0 d-flex flex-column h-100 bg-light">
                        <!-- Drop Zone -->
                        <div id="dropZone" class="flex-grow-1 d-flex flex-column align-items-center justify-content-center p-5 text-center transition-all" 
                            ...
                            <input type="file" id="imageUpload" accept="image/*,application/pdf" class="d-none" onchange="handleFileSelect()">
                            <button class="btn btn-primary px-4 shadow" onclick="document.getElementById('imageUpload').click()">
                        ...
                        <div id="previewWrapper" class="position-relative p-3 text-center" style="display: none;">
                            ...
                            <img id="previewImg" class="img-fluid rounded shadow-sm border border-white" style="max-height: 550px; background: white;">
                        </div>
                        ...
                        <div class="p-3 bg-white border-top mt-auto">
                            <div class="row no-gutters">
                                ...
                                <div class="col-6 pl-2">
                                    <button class="btn btn-outline-info btn-block d-none" id="processAllBtn" onclick="processAllPages()">
            ...
            <div class="col-xl-5">
                <div class="card card-sm border-0 shadow-lg h-100 mb-4 overflow-hidden">
                    <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                        <h6 class="font-weight-bold m-0 text-success"><i class="fas fa-file-alt mr-2"></i>EXTRACTED CONTENT</h6>
                        <div class="btn-group">
                            <button class="btn btn-xs btn-light" onclick="copyToClipboard()" id="copyBtn" title="Copy Text">
                    ...
                    <div class="card-body p-0 d-flex flex-column h-100 bg-white">
                        ...
                        <div id="progressContainer" class="p-3 border-bottom bg-light" style="display: none;">
                            ...
                            <div class="progress" style="height: 6px; border-radius: 10px;">
                                <div id="progressBar" class="progress-bar progress-bar-striped progress-bar-animated shadow-sm" role="progressbar" style="width: 0%"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex-grow-1 position-relative">
                            ...
                            <!-- Confidence Badge -->
                            <div id="confidenceBadge" class="position-absolute" style="bottom: 20px; right: 20px; display: none;">
                        ...
                        <div class="p-3 bg-light border-top">
                            <button class="btn btn-success btn-block font-weight-bold" id="processManuallyBtn" style="display:none;" onclick="processUploadedImage()">
                                <i class="fas fa-play mr-2 text-white"></i> Start Recognition
                            </button>
                            <div class="text-center small text-muted font-italic">
                                <i class="fas fa-shield-alt mr-1 text-primary"></i> Local browser processing. Your data stays private.
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="cameraModal" tabindex="-1" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-2xl" style="background: rgba(255,255,255,0.9); backdrop-filter: blur(10px);">
                ...
                <div class="modal-body text-center p-4">
                    <div class="position-relative d-inline-block rounded-lg shadow border-white border-4 overflow-hidden mb-3">
                        <video id="video" autoplay playsinline style="width: 100%; max-height: 50vh; display: block;"></video>
                        <div class="camera-grid"></div>
                    </div>
                    <div>
                        <button class="btn btn-primary btn-lg rounded-pill px-5 shadow-lg" id="captureBtn" onclick="captureImage()">
...
@push('js')
    ...
    <script>
        ...
        dz.addEventListener('dragover', (e) => { e.preventDefault(); dz.style.borderColor = '#3b82f6'; dz.style.background = '#f8fafc'; });
        dz.addEventListener('dragleave', (e) => { e.preventDefault(); dz.style.borderColor = '#cbd5e1'; dz.style.background = 'white'; });
...
@push('css')
    <style>
        .bg-blue-soft { background-color: rgba(59, 130, 246, 0.08); }
        ...
        #dropZone:hover { transform: scale(1.01); background-color: #f1f5f9 !important; border-color: #3b82f6 !important; }
        #dropZone:hover i { transform: translateY(-5px); color: #1d4ed8; }
