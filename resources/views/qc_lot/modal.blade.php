    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form_edit" action="">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabelEdit">
                ...
                <div class="modal-body">
                    <div class="form-group col-12">
                        ...
                        <select name="product_id" id="edit_product_id" class="form-control" style="width: 100%;">
                            <option value="">--Pilih--</option>
                            @foreach ($products as $product)
                                <option value="{{ $product->id }}">[{{ $product->code }}] {{ $product->name }}</option>
                            @endforeach
                    ...
                    <div class="form-group col-12">
                        ...
                        <input name="lot_number" id="edit_lot_number" class="form-control" required>
                    </div>
                    <div class="form-group col-12">
                        <label for="edit_lot_expiry">Lot Expiry</label>
                        <input name="lot_expiry" id="edit_lot_expiry" class="form-control" type="text">
                    </div>
                    <div class="form-group col-12">
                        <label for="edit_qc_date">QC Date</label>
                        <input name="qc_date" id="edit_qc_date" class="form-control" type="text">
                    </div>
                    <div class="form-group col-12">
                        <label for="edit_qc_by">QC By</label>
                        <input name="qc_by" id="edit_qc_by" class="form-control" required>
                    </div>
                    <div class="form-group col-12">
                        <label for="edit_qc_note">QC Note</label>
                        <div class="input-group">
                            <textarea name="qc_note" id="edit_qc_note" class="form-control" maxlength="200"></textarea>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn_update" type="submit" class="btn btn-primary">
