@extends('template', ['title' => 'Import Data Problem'])
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <h4><i class="fas fa-file-excel mr-1"></i>Import Data Problem</h4>
                    </div>
                    <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $('#sheet_buttons').on('click', '.btn-load-sheet', function() {
                ...
                json.forEach((element, index) => {
                    if (index >= 11) {
                        let date = formatDateExcel(element[1]);
                        let no = element[2] || lastno;
                        if (no) {
                            lastno = no;
                        }
                        let product = element[3] || '';
                        let sn = element[5] || '';
                        let hasil = element[6];
                        let stok = element[7] ? true : false;
                        let qty = element[9];
                        let ri_po = element[10];
                        let email = element[11] ? formatDateExcel(element[11]) : '';
