<div class="card card-sm">
    <div class="card-header d-flex align-items-center flex-wrap" style="gap: 8px;">
        {{-- Left: Gudang + Search + Refresh --}}
        <div class="d-flex align-items-center flex-wrap" style="gap: 6px; flex: 1;">
            <select id="gudangSelect" class="form-control form-control-sm" style="width: auto; min-width: 150px;">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-modern" id="tableIT" style="width:100%">
                <thead>
                    <tr>
                        <th>NO IT</th>
                        <th>FDATE</th>
