...
@push('js')
    ...
    <script>
        const URL_INDEX = "{{ route('it.index') }}"
        const URL_INDEX_API = "{{ route('api.it.index') }}"
        var id = 0;
        ...
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return `<button class="btn btn-sm btn-success btn-print" data-id="${data}" title="Print">
            ...
            $('#table tbody').on('click', '.btn-print', function(e) {
                e.preventDefault();
                e.stopPropagation();
            ...
            $('#table tbody').on('click', 'tr', function(e) {
                ...
                $('#modal_productLabel').html(`<i class="fas fa-list mr-2"></i>Item: ${rowData.name}`);
