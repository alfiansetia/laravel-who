        ...
        <div class="card card-sm">
            <div class="card-header d-flex align-items-center flex-wrap" style="gap: 8px;">
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                    <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ route('alamats.create') }}'">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-modern" id="tableAlamat" style="width:100%">
                        <thead>
                            <tr>
                                <th style="width: 30px;">
    ...
    <script>
        ...
        function renderTable(data) {
            ...
            data.forEach(row => {
                html += `<tr data-id="${row.id}">
                    ...
                    <td class="text-center">${escapeHtml(row.koli)} Koli</td>
                </tr>`;
            });
        ...
        function renderPagination(page, totalPages, total) {
            ...
            $pag.off('click', '.page-btn').on('click', '.page-btn', function() {
                ...
                loadData();
                $('html, body').animate({
                    scrollTop: $('#tableAlamat').offset().top - 80
                }, 200);
            });
        }
